...
**Rama de origen:** `fase1-diagnostico-interbrazos` → `fase2-soporte-rampa` → `fase3-pertenencia-estructura` → `fase4-deficit-mezcla` (commit final `f9ac901`). Documentación detallada en `simulador_ocular/docs/experimentos/ricco/{interbrazos,soporte,pertenencia,deficit}/`.
...
|---|---|---|---|
| 1 — Diagnóstico | `fase1-diagnostico-interbrazos` | `acbf335`, `538f8ef` | `simulador_ocular/docs/experimentos/ricco/interbrazos/` |
| 2 — Escala soporte | `fase2-soporte-rampa` | `581f1c7`, `a6c4d79` | `simulador_ocular/docs/experimentos/ricco/soporte/` |
| 3 — Estadístico soporte | `fase3-pertenencia-estructura` | `a89863b`, `6f707be`, `c4475ee`, `e5c0be5` | `simulador_ocular/docs/experimentos/ricco/pertenencia/` |
| 4 — Déficit mezcla | `fase4-deficit-mezcla` | `f9ac901` | `simulador_ocular/docs/experimentos/ricco/deficit/` |
