...
Respaldo: `simulador_ocular/docs/notas/resolucion-dobles.md`, con fuentes primarias para el
...
2. **Está en contradicción abierta con el render.**
   `simulador_ocular/docs/notas/separacion-dobles-dibujo.md` documenta que el DIBUJO
