...
`simulador_ocular/docs/referencias/deteccion_textura_bibliografia.md`.
...
(`simulador_ocular/docs/experimentos/velo_granularidad.md`), anillo nuclear r/r_h 0,00–0,25 salvo
donde se indique.
...
`simulador_ocular/docs/experimentos/velo_granularidad.md`) dominan sobre la energía filtrada y eso
...
`simulador_ocular/docs/iteraciones/v8_bugfix_grano_sbf.md`) ni sobre abiertos.
