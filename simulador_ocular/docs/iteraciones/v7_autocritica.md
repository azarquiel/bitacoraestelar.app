...
archivado en `simulador_ocular/docs/validacion/trager1995.tsv`, 1061 puntos de los cuatro cúmulos.
...
- **Los documentos de trabajo estaban en la raíz**, donde CLAUDE.md reserva
  `CONTEXT.md` y `simulador_ocular/docs/adr/`. **Movidos** a `simulador_ocular/docs/`, junto a los datos.
